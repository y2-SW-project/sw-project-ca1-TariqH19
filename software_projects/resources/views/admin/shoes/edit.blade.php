      ...
      <div class="col-md-8 col-md-offset-2">
        <div class="card">
          ...
          this code looks after displaying the correct error message to the user -->
            ...
            @endif
            <form method="POST" action="{{ route('admin.shoes.update', $shoe->id)}}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="description" name="description" value="{{ old('description', $shoe->description) }}" />
              </div>
